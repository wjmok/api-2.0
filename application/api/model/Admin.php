...
class Admin extends BaseModel{
    ...
    {   
        $standard = ['name','password','realname','phone','headImg','merchant_id','create_time','update_time','delete_time','lastlogintime','thirdapp_id','primary_scope','cms_scope','menu_scope','category_scope','function_scope','status'];
    ...
    public static function adminGet($data)
    {
        $class = "Admin";
